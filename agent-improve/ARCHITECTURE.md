...
> extracted to `docs/_archive/ARCHITECTURE_v2216_registers.md` before this copy replaced
...
> 2026-09-01.** It previously lived in `docs/_archive/DEFINE_FINALIZATION_2026-08-26.md`,
...
> archived file verbatim.** (archived to docs/_archive/; canonical: ARCHITECTURE.md §39.1.2)
