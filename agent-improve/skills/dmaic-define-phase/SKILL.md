...
## The ten fields, in coached order

`field_index` walks this sequence (§39.1.2). Tier 1 blocks the gate; Tier 2
warns only (§35).
...
| 2 | `team` | 1 |
| 3 | `voc_summary` | 1 |
| 4 | `problem_statement` | 1 |
| 5 | `baseline` | 1 |
| 6 | `project_scope` | 1 |
| 7 | `goal_statement` | 1 |
| 8 | `target_date` | 2 |
| 9 | `process_map_sipoc` | 1 |
| 10 | `issues_and_barriers` | 1 |
