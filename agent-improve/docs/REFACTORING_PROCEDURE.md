...
| **13** | The coach's own process is graded every turn — the coaching rubric scores the turn | `backend.tests.test_capability_rows::test_row_13_the_coaching_rubric_scores_the_turn` | 🟢 | **6.49** · **6.52** |
