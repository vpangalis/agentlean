...
| 4.2 | `thread_id` through `graph.ainvoke` + disconnect policy | §16, §47, §49 | ✅ done *(first live checkpoints ever. §47: 3 in, 2 deferred — WATCH 13, 14. Also fixed `checkpoint_ns` in the blob layout — DECISIONS Part Z3)* |
