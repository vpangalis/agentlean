...
**Progress: 10 of 35 build steps done** (2.3, 2.4, 2.5, 2.6, 2.7, 3.1, 3.2, 3.3, 3.4 + 9.0 out-of-band). **Next: step 3.5.**
...
| 3.5 | `storage/blob.py` — class → functions, sync → aio **(S-C08)** | §54, §10, §49 | ▶ **next** |
