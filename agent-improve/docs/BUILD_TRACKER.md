...
**Progress: 2 of 34 build steps done** (2.3 + 9.0 out-of-band). **Next: step 2.4.**
...
| 2.4 | `set_entry_point` → `add_edge(START, …)` | §12 | ▶ **next** |
| 2.5 | Async conversion (all nodes `async def`) | §14, §49 | ☐ |
