# CLAUDE.md v2.2.46 — verbatim, archived 2026-09-26 (step 6.67)

Founder ruling 2026-09-26, the three-layer conversion: CLAUDE.md becomes how to work here (<= 80 lines). This is the whole v2.2.46 text as it stood at commit 796ced5. §21 moved verbatim to `.claude/rules/coaching-move.md`; the amendment procedure to the `amend-rules` skill; the rest is here.
