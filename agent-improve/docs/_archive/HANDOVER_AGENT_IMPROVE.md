...
- Founder/developer: Vassilis Pangalis `<REDACTED 2026-09-13 — contact addresses; see the founder, not this file>`
...
- Azure Blob container: `agent-improve-cases` on `<REDACTED 2026-09-13 — storage account name; read from .env>`
...
> you do. **The PAT never entered git history**: it was removed from this file
> on 2026-08-20, while the file was still untracked, and the file was tracked
> only afterwards.
>
> **Tracking note (2026-09-13, step 6.25).** This file moved from
> `agent-improve/_Claude_chat_Prompts/` into `docs/_archive/` and is tracked,
> because `response-to-audit-2026-08-19.md` cites it and a tracked document
> citing an untracked file is a citation that resolves for one reader and no
> one else (CLAUDE.md §0.32, ARCHITECTURE.md §55.1). **This repository is
> public**, so three identifiers were redacted on the way in: the storage
> account name and two contact addresses. Nothing else was changed — the rest
> is the historical record and is left as written, including the operational
> details that were already in the public tree.
