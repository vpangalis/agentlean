# CLAUDE.md v2.2.44 — verbatim, archived 2026-09-25 (step 6.66)

Founder ruling 2026-09-25: CLAUDE.md becomes rules and pointers only (target <= 150 lines). Every "why", history and dated incident it carried is preserved here, verbatim, as it stood at v2.2.44 (commit 669b39c). The rule sentences remain binding in `agent-improve/CLAUDE.md`; this copy is history.
