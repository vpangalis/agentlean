...
from backend.content_ingestion import (
    upload_evidence,
    upload_knowledge_from_envelope,
    upload_knowledge_file,
)
from backend.reasoning_handler import handle_ai_reasoning
from backend.suggestion_engine import generate_suggestions as _generate_suggestions
