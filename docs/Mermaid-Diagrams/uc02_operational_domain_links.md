...
## Arrow 9 — graph.py → operational_node.py
...
## Arrows 10–13 — operational_node.py → tools.py → Azure AI Search (knowledge — ALL branches)
...
## Arrows 14–17 — Branch A: New problem (no case loaded) — operational_node.py → Azure OpenAI
...
## Arrows 18–30 — Branch B: Closed case — operational_node.py → tools.py → Azure AI Search → Azure OpenAI
...
| 30 | Returns operational_draft { current_state:"closed", supporting_cases, referenced_evidence, suggestions } | [operational_node.py:114](../../backend/reasoning/nodes/operational_node.py#L114) |

---

## Arrows 31–43 — Branch C: Open / active case — operational_node.py → tools.py → Azure AI Search → Azure OpenAI
...
| 43 | Returns operational_draft { current_state, supporting_cases, referenced_evidence, suggestions } | [operational_node.py:167](../../backend/reasoning/nodes/operational_node.py#L167) |

---

## Arrows 44–51 — operational_reflection_node.py → Azure OpenAI
...
## Arrows 52–57 — routing.py → graph.py (escalation branch)
...
## Arrows 58–62 — response_formatter_node.py → reasoning_handler.py → cosolve-ui.js
